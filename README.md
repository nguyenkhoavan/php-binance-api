[![Latest Version](https://img.shields.io/github/release/vannk/php-binance-api.svg?style=flat-square)](https://github.com/vannk/php-binance-api/releases) 
[![GitHub last commit](https://img.shields.io/github/last-commit/vannk/php-binance-api.svg?style=flat-square)](#) 
[![HitCount](http://hits.dwyl.io/vannk/php-binance-api.svg)](http://hits.dwyl.io/vannk/php-binance-api) 
[![Packagist Downloads](https://img.shields.io/packagist/dt/vannk/php-binance-api.svg?style=flat-square)](https://packagist.org/packages/vannk/php-binance-api) 


[![Build Status](https://travis-ci.org/vannk/php-binance-api.svg?branch=master&style=flat-square)](https://travis-ci.org/vannk/php-binance-api) 
[![Coverage Status](https://coveralls.io/repos/github/vannk/php-binance-api/badge.svg?branch=master&style=flat-square)](https://coveralls.io/github/vannk/php-binance-api) 
[![CodeCov](https://codecov.io/gh/vannk/php-binance-api/branch/master/graph/badge.svg?style=flat-square)](https://codecov.io/github/vannk/php-binance-api/) 
[![Codacy Badge](https://api.codacy.com/project/badge/Coverage/683459a5a71c4875956cf23078a0c39b)](https://www.codacy.com/app/dmzoneill/php-binance-api?utm_source=github.com&utm_medium=referral&utm_content=vannk/php-binance-api&utm_campaign=Badge_Coverage)
[![Code consistency](https://squizlabs.github.io/PHP_CodeSniffer/analysis/vannk/php-binance-api/grade.svg?style=flat-square)](https://squizlabs.github.io/PHP_CodeSniffer/analysis/vannk/php-binance-api)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/683459a5a71c4875956cf23078a0c39b)](https://www.codacy.com/app/dmzoneill/php-binance-api?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=vannk/php-binance-api&amp;utm_campaign=Badge_Grade)
...
#### Installation
```
composer require "vannk/php-binance-api @dev"
```
<details>
...
```
php composer.phar require "vannk/php-binance-api @dev"
```

#### Windows:
[Download installer for Windows](https://github.com/vannk/php-binance-api/#installing-on-windows)

</details>

#### Getting started
`composer require vannk/php-binance-api`
```php
...
```
See [additional options](https://github.com/vannk/php-binance-api/#config-file-in-home-directory) for more options and help installing on Windows
...
4. ```composer require vannk/php-binance-api```
...
```bash
mkdir -vp ~/.config/vannk/
cat >  ~/.config/vannk/php-binance-api.json << EOF
{
    "api-key": "<api key>",
    "api-secret": "<secret>"
}
...
https://github.com/vannk/php-binance-api/tree/gh-pages
